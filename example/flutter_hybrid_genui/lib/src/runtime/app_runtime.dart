...
final class ModelRuntimeStatus {
  ...
  factory ModelRuntimeStatus.fromPreparation({
    required ModelConfig config,
    required LlamaModelPreparationSnapshot snapshot,
    required String assetLabel,
  }) {
    return ModelRuntimeStatus(
      config: config,
      phase: switch (snapshot.stage) {
        LlamaModelPreparationStage.idle => ModelRuntimePhase.idle,
        LlamaModelPreparationStage.resolving => ModelRuntimePhase.resolving,
        LlamaModelPreparationStage.checkingCache =>
          ModelRuntimePhase.checkingCache,
        LlamaModelPreparationStage.downloading => ModelRuntimePhase.downloading,
        LlamaModelPreparationStage.verifying => ModelRuntimePhase.verifying,
        LlamaModelPreparationStage.loading => ModelRuntimePhase.loading,
        LlamaModelPreparationStage.ready => ModelRuntimePhase.ready,
        LlamaModelPreparationStage.failed => ModelRuntimePhase.failed,
        LlamaModelPreparationStage.cancelled => ModelRuntimePhase.cancelled,
      },
      assetLabel: assetLabel,
      progress: snapshot.fraction,
      resolvedModelPath: snapshot.modelEntry?.filePath,
